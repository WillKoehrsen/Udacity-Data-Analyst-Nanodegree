...
Pete Palmer, the legendary statistician, who has edited most of the
baseball encylopedias published since 1974. He is solely responsible
for bringing the batting, pitching, and fielding data out of the dark
ages and into the computer era.  Without him, none of this would be
possible.  For more on Pete's work, please read his own account at:
...
editor for three editions of Total Baseball and contributed to three
...
databases to be used together.

Since 2001, these two Seans have led a group of researchers
who volunteered to maintain and update the database.  Five of those
researchers have made substantial contributions to version 5.0 of this
database. Listed alphabetically, they are: Derek Adair, Mike Crain, 
Kevin Johnson, Tom Tango, and Paul Wendt. These folks did most
of the heavy lifting, and are largely responsible for the improvements
made to the current release.

Others who made important contributions include: Clifford Blau, 
Bill Burgess, Clem Comly, Jeff Burk, Randy Cox, Mitch Dickerman,
Paul DuBois, Mike Emeigh, F.X. Flinn, Bill Hickman, Jerry Hoffman,
Dan Holmes, Micke Hovmoller, Peter Kreutzer, Danile Levine,
Bruce Macleod, Ken Matinale, Michael Mavrogiannis, Rod Nelson,
Cliff Otto, Alberto Perdomo, Dave Quinn, Tom Ruane, Theron Skyles,
Michael Westbay, and Rob Wood.
...
quality of the underlying data has been tremendous. His creation at
...
has compiled.  His work will be continued by the SABR Business of 
Baseball committee.  
...
Bruce Markusen, and the rest of the staff.  Dan Holmes has been
a great liason between the folks who work on this database and
the folks at the Hall of Fame.
...
It is supplemented by these tables:
  ...
  AllStar/AllStarFull - All-Star appearances
...
finalGamw      Date that player made first major league appearance (blank if still active)
...
category       Category in which can
------------------------------------------------------------------------------
2.7  Managers table
...
------------------------------------------------------------------------------
2.27 xref_stats table
playerID       player ID code
statsID        STATS player ID code	
bisID          BIS player ID code
<end of file>
